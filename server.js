...
const server = http.createServer((req, res) => {
  ...
  // CSS / JS / 画像ファイルを配信
  if (req.method === "GET" && /\.(css|js|png|jpe?g|svg|webp|gif)$/i.test(req.url)) {
    ...
    fs.readFile(file, (e, data) => {
      ...
      const types = { css:"text/css; charset=utf-8", js:"text/javascript; charset=utf-8", png:"image/png", jpg:"image/jpeg", jpeg:"image/jpeg", svg:"image/svg+xml", webp:"image/webp", gif:"image/gif" };
